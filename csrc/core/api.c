...
geo_status_t geo_ecef_distance_surface_m(const geo_ecef_t* a, const geo_ecef_t* b, double* out_m) {
    ...
    return geo_ecef_distance_surface_impl(a, b, out_m);
}

geo_status_t geo_ecef_distance_surface_with_elevation_m(const geo_ecef_t* a, const geo_ecef_t* b,
                                                               double* out_m) {
    if (!a || !b || !out_m) return GEO_ERR_PARSE;
    return geo_ecef_distance_surface_with_elevation_impl(a, b, out_m);
}
