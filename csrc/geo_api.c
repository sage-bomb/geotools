...
geo_status_t geo_ll_to_geohash_wgs84(double lat_deg, double lon_deg, int precision,
                                     char* out_str, size_t out_sz) {
...
geo_status_t geo_ecef_to_geohash_wgs84(const geo_ecef_t* ecef, int precision,
                                      char* out_str, size_t out_sz) {
