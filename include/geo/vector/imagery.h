...
typedef struct {
  /*
   * Affine mapping from image pixel space to geodetic LLH:
 ...
 */
GEO_API geo_status_t geo_imagery_fit_affine_tie_points(const geo_tie_point_t* points,
                                                              size_t count,
...
GEO_API geo_status_t geo_imagery_project_pixel(const geo_tie_point_affine_model_t* model,
                                                      double image_px,
                                                      double image_py,
                                                      geo_llh_t* out_llh);
 ...
 */
GEO_API geo_status_t geo_imagery_solve_tie_points(const geo_tie_point_t* points,
                                                         size_t count,
                                                         geo_tie_point_fit_stats_t* out_stats);
